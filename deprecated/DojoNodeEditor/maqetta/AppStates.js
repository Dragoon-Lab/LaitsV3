 ...
 *
 */
define(["../../../www/dojo/_base/connect", "dojo/dom-style", "dojo/dom", "dojo/_base/html", "dojo/_base/window", "dojo/_base/array", "dojo/parser", "require", "dojo/json", "dojo/_base/lang"],
...
(function(){
	...
	if (singleton.shouldInitialize()) {
		...
		if (typeof require != "undefined") {
			require(["../../../www/dojo/_base/lang", "dojo/query", "dojo/aspect"], function(lang, query, aspect) {
				var count = 0,
					alreadyHooked = false;
