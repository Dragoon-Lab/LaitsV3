...
ModelLibrary+=",Fall-from-building-1,Fall-from-building-2,Fall-from-building-3,Thrown-Stone-1,Thrown-Stone-2"
ModelLibrary+=",isle1,isle2,isle3,isle4,isle5,isle6,201,202,203,204"
ModelLibrary+=",zebra-population-growth-1,zebra-population-growth-2,zebra-population-growth-3,zebra-population-growth-4"
ModelLibrary+=",lion-population-growth-1,lion-population-growth-2,lion-population-growth-3,lion-population-growth-4,zebra-lions-independent-solo,zebra-lions-combined"
ModelLibrary+=",CPI-2014-ps1-01,CPI-2014-ps1-02,CPI-2014-ps1-03,CPI-2014-ps1-04,CPI-2014-ps1-05,CPI-2014-ps1-06,CPI-2014-ps1-07,CPI-2014-ps1-08,CPI-2014-ps1-09,CPI-2014-ps1-10,CPI-2014-ps1-11"
ModelLibrary+=",CPI-2014-ps1-12,CPI-2014-ps2-01,CPI-2014-ps2-02,CPI-2014-ps2-03,CPI-2014-ps2-04,CPI-2014-ps2-05,CPI-2014-ps2-06,CPI-2014-ps2-07,CPI-2014-ps2-08,CPI-2014-ps2-09"
...
echo "##########################################"
node scripts/problemTester.js -p $ModelLibrary -m STUDENT >> ModelLibraryStudentTest.log
