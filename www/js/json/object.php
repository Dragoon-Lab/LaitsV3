...
//                oldModel.buildModel();
                ...
                var string = '{ "Task": {"Phase": "Intro","Type": "Construct","Properties": {"TaskName": "Rabbits - Intro Problem","URL": "images/rabbit.jpeg","StartTime": 0,"EndTime": 10,"Units": "Years"},"TaskDescription": "In this exercise, you will construct a model of how a rabbit population grows when no rabbits die. The first quantity in this model is the population or number of rabbits in the population. Initially, there are 100 rabbits, but the number increases with time. The new population each month is its present value plus the number of births (number of rabbits born each month).  The number of births is equal to the product of the population and the birth rate. The birthrate or the ratio of the number of rabbits born in a month to the rabbit population that month has a fixed value of 0.2.","Nodes": [{"Node": {"Type": "stock","ID": "id1","Name": "population","Extra": "no","Order": 1,"Units": "","Inputs": [{"ID": "id2"}],"Position": {"X": 250,"Y": 150},"Initial": 100,"Equation": "+id2","CorrectDescription": "The number of rabbits in the population","AttemptCount": {"Desc": 5,"Plan": 1,"Calc": 2},"StudentSolution": {"Desc": "demo","Plan": "correct","Calc": "incorrect"}}},{"Node": {"Type": "flow","ID": "id2","Name": "births","Extra": "no","Order": 2,"Units": "","Inputs": [{"ID": "id1"},{"ID": "id3"}],"Position": {"X": 350,"Y": 150},"Equation": "id1 * id3","CorrectDescription": "The number of rabbits born each month","AttemptCount": {"Desc": 1,"Plan": 0,"Calc": 0},"StudentSolution": {"Desc": "incorrect","Plan": "","Calc": ""}}},{"Node": {"Type": "constant","ID": "id3","Name": "birth rate","Extra": "no","Order": 3,"Units": "","Position": {"x": 300,"y": 250},"Equation": ".2","CorrectDescription": "The ratio of number of rabbits born in a month to the rabbit population that month","AttemptCount": {"Desc": 0,"Plan": 0,"Calc": 0},"StudentSolution": {"Desc": "","Plan": "","Calc": ""}}}],"StudentModel": [{"Node": {"ID": "id1","Name": "population","Inputs": [{"ID": "id2"}],"Position": {"X": 250,"Y": 150},"StudentSelections": {"Desc": "The number of rabbits in the population","Plan": "accumulator","Initial": "10","Equation": "+ id1"}}},{"Node": {"ID": "id2", "Name": "births","Inputs": [{"ID": "id1"},{"ID": "id3"}],"Position": {"X": 350,"Y": 150},"StudentSelections": {"Desc": "The ratio of rabbits born with super powers to ordinary rabbits","Plan": "","Initial": "","Equation": ""}}}]}}';
