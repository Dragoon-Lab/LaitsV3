    ...
    <body>
        ...
        <script>
            require(["/laits/js/json/model"], function(model) {
                ...
                rabbits.setStudentNodeSelection("id1", "description", "The number of rabbits in the population");
