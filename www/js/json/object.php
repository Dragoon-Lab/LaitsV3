    ...
    <body>
        ...
        <script>
            require(["/laits/js/json/model"], function(model) {
                ...
                rabbits.setNodeType(rabbitID, "stock");
                ...
                rabbits.setStudentSelectionsDesc("id1", "The number of rabbits in the population");
                rabbits.setStudentSelectionsPlan("id1", "stock");
                ...
                rabbits.setStudentSelectionsDesc("id2", "The number of rabbits born each month");
                rabbits.setStudentSelectionsPlan("id2", "flow");
                ...
                rabbits.setStudentSelectionsDesc("id3", "The ratio of number of rabbits born in a month to the rabbit population that month");
                rabbits.setStudentSelectionsPlan("id3", "constant");
