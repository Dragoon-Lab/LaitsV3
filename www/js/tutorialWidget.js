...
define([
	...
	var widget = function(){
		...
		}, 
		{
			...
			content : "You will use Dragoon to build models that calculate graphs and tables of system quantities.  Note how The graphs change instantly as you manipulate the sliders, check boxes and menus.",
		},
		{
			title : "How it Works",
	...
	widget.prototype.begin = function(c){
		...
		on(dom.byId("tutorialImage"), "load", function(){
			dom.byId("tutorialHeading").innerHTML = s.title;
