    ...
    return declare(controller, {
            ...
            if (modelType === "correct") {
                ...
                if (equation.value && !this.equationEntered) {
                    ...
                    this.applyDirectives([
                        {
                            id: "crisisAlert", attribute: "open", value: "Your expression has not been checked!  Go back and check your expression to verify it is correct, or delete the expression, before closing the node editor."
                        }
                    ]);
                    registry.byId("selectModel").set('value', "correct");
                }
                ...
                if (typeof equation != "undefined" && eqn != null && eqn != "") {
                    ...
                    array.forEach(parse.variables(), lang.hitch(this, function (variable) {
                        ...
                        if (studentID != null) {
                            ...
                            this.applyDirectives([
                                {
                                    id: "crisisAlert", attribute: "open", value: "You are trying to add a node that is not part of student model."
                                }
                            ]);
                ...
                if (this.errorStatus.length > 0) {
                    array.forEach(this.errorStatus, lang.hitch(this, function (errorNode, index) {
                        if (errorNode.id == this.currentID) {
                            ...
                            this.applyDirectives([
                                {
                                    id: "crisisAlert", attribute: "open", value: "The expression in Initial Student Values was cleared because nodes were missing from the student model."
                                }
                            ]);
                            return;
                        }
        ...
        initialControlSettings: function (nodeid) {
            ...
            if (type && type != 'function') {
                if (typeof this._model.given.getInitial(this.currentID) === "number")
                    this.applyDirectives([
                        {id: "initial", attribute: "status", value: "entered"}
                    ]);
            }
            if (type && type != 'parameter') {
                if (this._model.given.getEquation(this.currentID))
                    this.applyDirectives([
                        {id: "equation", attribute: "status", value: "entered"}
                    ]);
            }
        },
