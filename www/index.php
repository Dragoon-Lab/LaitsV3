...
<div id="main" data-dojo-type="dijit/layout/BorderContainer" gutters="false">
    <div data-dojo-type="dijit/MenuBar" id="menuBar" region="top" splitter="false">
        ...
        <button type="button" data-dojo-type="dijit/form/Button" id="forumButton" disabled="true" style="display: none">Forum</button>
        <button type="button" data-dojo-type="dijit/form/Button" id="schemaButton" disabled="true" style="display: none">Create Schema</button>
        ...
        <button type="button" data-dojo-type="dijit/form/Button" id="prettifyButton" style="display: none">Prettify</button>
    ...
    <div class="claro sameedit" data-dojo-type="dijit/Dialog" id="nodeeditor">
        ...
        <div class="fieldgroup">
            ...
            <div class="buttonBox" style="padding-top:0px">
                ...
                <button id="nodeForumButton" type="button" data-dojo-type="dijit/form/Button" iconClass="dijitNoIcon" disabled="true">Forum</button>
            </div>
...
<script type="text/javascript" src="ET/Util/emacs5-compatibility-patches.js"></script>
<script type="text/javascript" src="ET/Util/uuid.js"></script>
<script type="text/javascript" src="ET/Util/encoder.js"></script>
<script type="text/javascript" src="ET/Util/zet.js"></script>
<script type="text/javascript" src="ET/Util/serialization.js"></script>
<script type="text/javascript" src="ET/Core/messaging.js"></script>
<script type="text/javascript" src="ET/Core/messaging-gateway.js"></script>
<script type="text/javascript" src="ET/Services/Orchestration/heartbeat-service.js"></script>
