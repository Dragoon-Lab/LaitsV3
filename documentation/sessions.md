...
## Retrieving student completed problems from the database ##

Student solutions are saved in the solutions table but because of database 
optimization procedures, you will need to reference the session table as well to 
get a solution for a specific problem and user. You can use this query to access 
this information:
...
values, keeping the "%" operator in the date. You can remove any of the 
...
and push it to the "problems" directory on the master branch. It will be moved 
